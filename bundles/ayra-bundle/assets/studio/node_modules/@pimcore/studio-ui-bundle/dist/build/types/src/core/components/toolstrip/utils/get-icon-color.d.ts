 ...
 */
export declare function getToolStripIconColor({ additionalIcon, additionalIconAutoColor, disabled, toolStripTheme, isActivated, token }: GetIconColorParams): string | undefined;
export {};
