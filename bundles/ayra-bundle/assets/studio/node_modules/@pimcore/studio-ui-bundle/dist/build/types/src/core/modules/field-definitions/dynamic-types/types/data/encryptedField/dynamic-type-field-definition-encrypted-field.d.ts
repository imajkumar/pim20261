...
export declare const BASE_FIELD_KEYS: Set<string>;
export declare class DynamicTypeFieldDefinitionEncryptedField extends DynamicTypeFieldDefinitionDataAbstract {
    id: string;
    getIcon(): ElementIcon;
    getGroup(): string[];
