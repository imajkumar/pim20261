 ...
 */
import { type IInlineEditDecoratorConfig } from '../../../../modules/element/listing/decorators/inline-edit/inline-edit-decorator';
import { type IRowSelectionDecoratorConfig } from '../../../../modules/element/listing/decorators/row-selection/row-selection-decorator';
...
export declare class AssetListingBuilder<T extends IListingBuilder = IAssetListingBuilder> extends ListingBuilder<T> {
}
