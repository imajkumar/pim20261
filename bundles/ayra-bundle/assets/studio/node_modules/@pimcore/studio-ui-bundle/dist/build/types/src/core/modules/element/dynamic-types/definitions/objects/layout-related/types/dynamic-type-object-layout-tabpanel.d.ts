...
import { type TabpanelProps } from '../components/tabpanel/tabpanel';
export declare class DynamicTypeObjectLayoutTabpanel extends DynamicTypeObjectLayoutAbstract {
