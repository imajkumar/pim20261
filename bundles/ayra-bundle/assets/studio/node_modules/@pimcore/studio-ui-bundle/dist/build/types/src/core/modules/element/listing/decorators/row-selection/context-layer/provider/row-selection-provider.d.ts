 ...
 */
import { type GridProps } from '../../../../../../../modules/element/listing/abstract/view-layer/components/grid/hooks/use-grid-options';
...
export declare const RowSelectionContext: React.Context<RowSelectionContextProps>;
export interface RowSelectionProviderProps {
    children: React.ReactNode;
}
export declare const RowSelectionProvider: ({ children }: RowSelectionProviderProps) => React.JSX.Element;
