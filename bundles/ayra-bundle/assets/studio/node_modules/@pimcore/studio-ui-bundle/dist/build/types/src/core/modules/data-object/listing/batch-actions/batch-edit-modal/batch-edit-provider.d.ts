...
export declare const BatchEditContext: React.Context<BatchContext>;
export interface BatchEditProviderProps {
    children: React.ReactNode;
}
export declare const BatchEditProvider: ({ children }: BatchEditProviderProps) => React.JSX.Element;
