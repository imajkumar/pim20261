...
export type TransformationType = 'cover' | 'resize' | 'scaleByWidth' | 'scaleByHeight' | 'trim' | 'sepia' | 'grayscale' | 'sharpen' | 'contain' | 'crop' | 'frame' | 'rotate' | 'mirror' | 'gaussianBlur' | 'brightnessSaturation' | 'setBackgroundColor' | 'setBackgroundImage' | 'roundCorners' | 'addOverlay' | 'addOverlayFit' | 'applyMask' | 'tifforiginal' | '1x1_pixel';
