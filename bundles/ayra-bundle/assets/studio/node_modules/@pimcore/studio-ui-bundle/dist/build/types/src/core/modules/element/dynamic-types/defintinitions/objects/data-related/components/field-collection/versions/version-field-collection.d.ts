...
export declare const VersionFieldCollection: ({ value, fieldBreadcrumbTitle, className, fieldCollectionModifiedList, isExpandedUnmodifiedFields }: VersionFieldCollectionProps) => React.JSX.Element;
