 ...
 */
export declare const createSafeTestIdString: (input: string | number) => string;
/**
 ...
 */
export declare const buildTestId: (parts: Array<string | number | undefined>, separator?: string) => string;
/**
 ...
 */
export declare const createNodeTestId: (id: number | string, elementType?: string) => string;
/**
 ...
 */
export declare const createBorderTestId: (nodeId?: string, nodeName?: string, elementType?: string) => string;
/**
 ...
 */
export declare const createTreeTestId: (treeId: string) => string;
/**
 ...
 */
export declare const createTabTitleTestId: (title: string, elementId?: number | string, elementType?: string) => string;
/**
 ...
 */
export declare const createTreeNodeTestId: (id: number | string, type: string) => string;
/**
 ...
 */
export declare const createTabContentTestId: (context: number | string, options?: {
    prefix?: string;
    tabKey?: string;
}) => string;
/**
 ...
 */
export declare const createTableTestId: (tableType: string) => string;
/**
 ...
 */
export declare const createTableRowTestId: (rowIdentifier: number | string) => string;
export declare const createTableCellTestId: (rowIdentifier: number | string, columnId: string) => string;
export declare const createContextMenuContainerTestId: (elementType: ElementType, nodeId: number | string) => string;
export declare const createContextMenuItemTestId: (key: string) => string;
/**
 ...
 */
export declare const createModalButtonTestId: (buttonType: string, modalType?: string) => string;
