 ...
 */
export declare const relationArrayToObjects: <K extends string>(key: K) => (values: string[] | undefined | null) => Array<SingleKeyObject<K, string>>;
/**
 ...
 *   { value: ['snippet'] }
 */
export declare const relationObjectsToValueProps: <K extends string>(key: K) => (value: Array<SingleKeyObject<K, string>> | undefined | null) => {
    value: string[];
};
/**
 ...
 */
export declare const relationSelectFormItemTransformation: (key: string) => {
    getValueFromEvent: (values: string[]) => Array<SingleKeyObject<string, string>>;
    getValueProps: (value: Array<SingleKeyObject<string, string>>) => {
        value: string[];
    };
};
