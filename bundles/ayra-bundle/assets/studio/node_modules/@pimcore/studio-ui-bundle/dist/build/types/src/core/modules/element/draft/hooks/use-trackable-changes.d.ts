...
export declare const useTrackableChangesReducers: (entityAdapter: EntityAdapter<TrackableChangesDraft, number>) => UseTrackableChangesReturn;
...
export declare const useTrackableChangesDraft: (id: number, resetChangesAction: ActionCreatorWithPayload<number>, setModifiedCellsAction: ActionCreatorWithPayload<ModifiedCellsAction>) => UseTrackableChangesDraftReturn;
export {};
